...
# - Platform: Java
# - Platform branch: corretto17 Linux 2023
...
#Step 3: Create a CodePipeline có nhiệm vụ tích hợp CodeCommit, CodeBuild và ElaticBeanstalk.
...
#Step 4: Modify code, push lên CodeCommit.
